...
// Create query URL for the REST API. Note &_embed at the end which brings in featured images.
const queryURL = `${restURL}posts?per_page=3&categories=${catIDs}&exclude=${postID}&_embed`;
...
function thePost( postObject ) {
    console.log('postObject triggered');
